...
export default function Navbar({ active }: { active: 'Home' | 'Page1' | 'Page2' }) {
    return (
            <div className="bg-red-500 flex flex-row justify-between items-center p-4 w-full fixed top-0 z-50">
                <Link href={'/'}>
                    <svg
